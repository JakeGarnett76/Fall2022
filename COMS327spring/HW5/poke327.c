...
void game_loop()
{
  ...
  while (1) {
    ...
    if (c == &world.pc) {
      ...
      if(input == '7' || input == 'y'){
        printf("%s\n", "PC one cell up one cell left");
        printf("Input: %c", input);
        exit_check(-1,-1);
        if(terr_check(-1, -1)){
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
          world.pc.pos[dim_x] = world.pc.pos[dim_x] - 1;
          world.pc.pos[dim_y] = world.pc.pos[dim_y] - 1;
          world.cur_map->cmap[c->pos[dim_y] + 1][c->pos[dim_x] + 1] = NULL;
  ...
  //        input = '\0';
      ...
      if(input == '8' || input == 'k'){
        ...
        if(terr_check(-1, 0)){
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
          world.pc.pos[dim_x] = world.pc.pos[dim_x];
          world.pc.pos[dim_y] = world.pc.pos[dim_y] - 1;
          world.cur_map->cmap[c->pos[dim_y] + 1][c->pos[dim_x]] = NULL;
          world.cur_map->cmap[c->pos[dim_y]][c->pos[dim_x]] = c;
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
        }
      }
      ...
      if(input == '6' || input == 'l'){
        ...
        if(terr_check(0, 1)){
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
          world.pc.pos[dim_x] = world.pc.pos[dim_x] + 1;
          world.pc.pos[dim_y] = world.pc.pos[dim_y];
          world.cur_map->cmap[c->pos[dim_y]][c->pos[dim_x] - 1] = NULL;
          world.cur_map->cmap[c->pos[dim_y]][c->pos[dim_x]] = c;
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
        }
      ...
      if(input == '3' || input == 'n'){
        printf("%s\n", "PC one cell down one cell right");
        printf("Input: %c", input);
        exit_check(1,1);
        if(terr_check(1, 1)){
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
      ...
      if(input == '1' || input == 'b'){
        printf("%s\n", "PC one cell down one cell left");
        printf("Input: %c", input);
        exit_check(1,-1);
        if(terr_check(1, -1)){
          printf("\n%d, %d", world.pc.pos[dim_x], world.pc.pos[dim_y]);
...
int terr_check(int y1, int x1){
    printf("\nChecked Coords: %d, %d", world.pc.pos[dim_x] + x1, world.pc.pos[dim_y] + y1);
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_boulder){
    printf("\n%s", "A boulder blocks your path");
    return 0;
  }
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_tree){
    printf("\n%s", "A tree blocks your path");
    return 0;
  }
    if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_mountain){
    printf("\n%s", "A mountain blocks your path");
    return 0;
  }
  return 1;
...
void exit_check(int y1, int x1){
  //exit west
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_path && world.pc.pos[dim_x] + x1 == 0){
      world.cur_idx[dim_x] = world.cur_idx[dim_x] + x1;
      world.cur_idx[dim_y] = world.cur_idx[dim_y] + y1;
      new_map();
    printf("\n%s", "Travel west");
  }
  //exit east
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_path && world.pc.pos[dim_x] + x1 == 79){
      world.cur_idx[dim_x] = world.cur_idx[dim_x] + x1;
      world.cur_idx[dim_y] = world.cur_idx[dim_y] + y1;
      new_map();
    printf("\n%s", "Travel east");
  ...
  //exit north
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_path && world.pc.pos[dim_y] + x1 == 0){
      world.cur_idx[dim_x] = world.cur_idx[dim_x] + x1;
      world.cur_idx[dim_y] = world.cur_idx[dim_y] + y1;
      new_map();
    printf("\n%s", "Travel north");
  ...
  //exit south
  if(world.cur_map->map[world.pc.pos[dim_y] + y1][world.pc.pos[dim_x] + x1] == ter_path && world.pc.pos[dim_y] + y1 == 20){
      world.cur_idx[dim_x] = world.cur_idx[dim_x] + x1;
      world.cur_idx[dim_y] = world.cur_idx[dim_y] + y1;
      new_map();
    printf("\n%s", "Travel south");
